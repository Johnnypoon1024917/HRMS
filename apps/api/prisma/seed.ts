  ...
  const adminRole = await db.role.create({
    data: {
      ...
      permissions: [
        ...
        'trm.read', 'trm.admin', 'trm.import', 'trm.export',
        'ham.read', 'ham.write', 'ham.export',
        'cdm.read', 'cdm.write', 'cdm.read.restricted',
        'exm.read', 'exm.write', 'exm.import', 'exm.export',
        'hbm.read', 'hbm.write', 'hbm.bill', 'hbm.import', 'hbm.export',
